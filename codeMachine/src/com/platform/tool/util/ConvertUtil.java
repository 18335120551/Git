...
public class ConvertUtil {
	...
	// 获取实体类的类名
	// 数据库表规范,带业务后缀 _P权限表,_B基础表,_C业务表 转换类名去掉业务后缀,然后驼峰规则
	...
	// 把数据库中的字段转换为实体类中的属性:USER_ID ==>userId
	...
	// 首字母小写
	public static String formatLower(String source) {
		if (source == null)
			return null;
		if (source.equals(""))
			return "";
	...
	// 通过resultSetMetaData对象获取字符串型的类型名
	public static String getTypeName1(int type) {
	...
	// 通过resultSetMetaData对象获取字符串型的类型名 mysql已验证
	// 数据库设计规范：VARCHAR,CHAR,INTEGER,NUMERIC(5,2),TIMESTAMP
